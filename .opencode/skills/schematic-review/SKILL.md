...
Use the `kicad-cli` skill for all data extraction. Read the skill instructions at `.claude/skills/kicad-cli/SKILL.md` (or `.opencode/skills/kicad-cli/SKILL.md` if available) for the full command reference.
