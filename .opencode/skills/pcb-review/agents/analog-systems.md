...
- `.opencode/skills/spice-sim/SKILL.md`
- `.opencode/skills/spice-sim/mosfet-models.md`
- `.opencode/skills/spice-sim/diode-models.md`
...
1. **Create simulation file** in `/tmp/pcb_review_sim_[subcircuit_name].cir`
2. **Include**:
...
3. **Run simulation**: `ngspice -b /tmp/pcb_review_sim_[name].cir -o /tmp/pcb_review_sim_[name].log`
...
SIMULATIONS RUN:
- /tmp/pcb_review_sim_[name].cir: [PASS/FAIL] — [brief result summary]
---
```
